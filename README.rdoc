= NOTE:
This project is no longer under active development and is not maintained. If you would like an actively maintained, API compatible, replacement please see 'MIDI SMTP Server': https://github.com/4commerce-technologies-AG/midi-smtp-server
...
You may also be interested in MidiSMTPServer: {https://github.com/4commerce-technologies-AG/midi-smtp-server/}[https://github.com/4commerce-technologies-AG/midi-smtp-server/]
